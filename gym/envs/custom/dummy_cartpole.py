...
class DummyCartPoleEnv(gym.Env):
    ...
    def __init__(self):
        ...
        with open(cfg_path) as f:
            ...
            self.action_lower_bound = config['test_configuration']['action_lower_bound']
            self.action_upper_bound = config['test_configuration']['action_upper_bound']
        ...
        self.action_space = spaces.Box(low=self.action_lower_bound, high=self.action_upper_bound, shape=(1,), dtype=np.float32)
